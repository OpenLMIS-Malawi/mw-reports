...
public class SupersetService {
   ...
   */
  public String getGuestToken(final String embeddedUuid, final String username,
  ...
  private String requestGuestToken(final String embeddedUuid, final String username,
                                   final String firstName, final String lastName) {
  ...
  private CsrfResult getCsrfToken(final String accessToken) {
    HttpHeaders headers = new HttpHeaders();
    headers.set("Authorization", "Bearer " + accessToken);
  ...
  private static class CsrfResult {
    ...
    CsrfResult(final String token, final String cookies) {
      this.token = token;
